...
public class HazyIntake extends SubsystemBase {
    ...
    public HazyIntake () {
        ...
        upDownTalon.config_kP(0, RobotMap.INTAKEUPDOWNP);
        upDownTalon.config_kI(0, RobotMap.INTAKEUPDOWNI);
        upDownTalon.config_kD(0, RobotMap.INTAKEUPDOWND);
        upDownTalon.config_kF(0, RobotMap.INTAKEUPDOWNF);
